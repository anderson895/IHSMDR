$(document).ready(function() {
    ...
    function fetchUsers() {
        ...
        $('#dataTable').on('click', '.edit-btn', function(e) {
            ...
            $.ajax({
                url: 'model/barangay accounts/get_.php', // Adjust the URL to your endpoint
                type: 'GET',
                data: { userId: userId },
                success: function(response) {
                    ...
                    $('#editProvince').val(response.province);
                    $('#editMunicipality').val(response.municipality);
    ...
    $('#editUserForm').submit(function(e) {
        ...
        var municipal = $('#editMunicipality').val();
        ...
        $.ajax({
            url: 'model/barangay accounts/edit_.php',
            type: 'POST',
            data: {
                userId: userId,
                firstName: firstName,
...
// Delete button click event
    ...
    function deleteUser(userId) {
        ...
        $.ajax({
            url: 'model/barangay accounts/del_.php',
            type: 'GET',
            data: { userId: userId },
            success: function(response) {
                Swal.fire({
        ...
        $.ajax({
            url: 'model/barangay accounts/fetch_.php',
            type: 'GET',
            dataType: 'json',
    ...
    $('#addUserForm').submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: "model/barangay accounts/add_.php",
            data: $(this).serialize(),
            success: function(response) {
