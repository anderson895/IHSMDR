                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="dispensingOfficer" name="dispensing_officer" value="<?php echo $_SESSION['name'] ?>" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="editDispensingOfficer" name="dispensing_officer" value="<?php echo $_SESSION['name'] ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
