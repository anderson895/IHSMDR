        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="dataTable1" class="table hover nowrap">
                        <thead>
                            <tr>
...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header p-4" style="background: linear-gradient(to bottom, rgba(214, 215, 219, 0.29), rgba(221, 221, 221, 0.5)); background-image: url('assets/img/Header - Top Background Image (1600x200).jpg'); background-position: center center; background-repeat: no-repeat;">
            <div class="page-title">
                <h4>Stock Expiring Within 6 Months</h4>
                <h6>View/Search Dispensed Medicines</h6>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="dataTable2" class="table hover nowrap">
                        <thead>
                            <tr>
                            <th>Medicine Brand</th>
                            <th>Generic</th>
...
<div class="page-wrapper">
    <div class="content">
        <div class="page-header p-4" style="background: linear-gradient(to bottom, rgba(214, 215, 219, 0.29), rgba(221, 221, 221, 0.5)); background-image: url('assets/img/Header - Top Background Image (1600x200).jpg'); background-position: center center; background-repeat: no-repeat;">
            <div class="page-title">
                <h4>Medicine Low on Stock</h4>
                <h6>View/Search Medicine Low on Stock</h6>
            </div>
        </div>
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="dataTable3" class="table hover nowrap">
                        <thead>
                            <tr>
                            <th>Medicine Brand</th>
                            <th>Generic</th>
...
$(document).ready(function() {
    ...
    function fetchDispensedMedicines() {
            ...
            columns: [
                ...
                { data: 'lot_number', orderable: true }, // Lot Number
                {
                    ...
                    render: function(data, type, row) {
                        // Check if expiry date is close or has passed
                        var today = new Date();
                        var expiryDate = new Date(data); // Assuming 'data' is in a valid date format (e.g., 'YYYY-MM-DD')
                        if (expiryDate <= today) {
        ...
        $.ajax({
            url: 'model/reports/expiration_date.php',
            type: 'GET',
            dataType: 'json',
            success: function(data) {
                dataTable.clear().rows.add(data).draw();
